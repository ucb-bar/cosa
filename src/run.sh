for i in {0..7}; do
    ...
    # python cosa.py -pp ../gemmini/prob/mm/mm_${i}.yaml  -o output_mm_${i}
    echo $i
done
...
for i in {0..7}; do
    ...
    grep 'Cycles: ' output_mm_${i}/timeloop-model.stats.txt 
    grep 'Energy: ' output_mm_${i}/timeloop-model.stats.txt
